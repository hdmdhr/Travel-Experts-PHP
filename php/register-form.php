  ...
  <form class="needs-validation" name="signupForm" method="post" action="customer-insert.php">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Your last name" required>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="homePhone" name="homePhone" placeholder="123-456-7890">
        <p class="input-hint-hidden">Your home phone.</p>
      </div>
      <div class="form-group col-md-6">
        <label for="busiPhone">Business Phone</label>
        <input type="text" class="form-control" id="busiPhone" name="busiPhone" placeholder="123-456-7890">
    ...
    <div class="form-group">
      ...
      <input type="text" name="address" class="form-control" id="address" placeholder="123 Main St">
      <p class="input-hint-hidden">Your current mailing address, include suite number.</p>
    </div>
    <div class="form-row">
      <div class="form-group col-md-4">
        <label for="city">City</label>
        <input type="text" name="city" class="form-control" id="city" placeholder="Calgary">
    ...
    <div class="row mb-4">
      <div class="col-md-4">
        ...
        <input type="text" class="form-control" id="userName" name="CustUserName" placeholder="username" value="" required>
    ...
    <div class="form-group">
      ...
      <input id="fav-city" class="form-control" name="" placeholder="City Name" minlength="2">
